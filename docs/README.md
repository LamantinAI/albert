...
- **[architecture.md](architecture.md)** — the assembly: Octo as the Reaction
  ...
  what is settled vs. what is Phase 2 (the graph cogitator).
...
CalDAV calendar) are assembled from manifests. It is the working-first cut: the staged
**graph** cogitator (explicit PEMRR nodes, checkpoint/rollback, steering) is Phase 2.
