...
description: when the user asks to remind them, set a reminder, not forget, add to calendar, or record a meeting — «напомни», «поставь напоминание», «не забыть», «добавь в календарь», «запиши встречу», «remind me», «add to calendar»
---
...
1. Resolve the time to an absolute ISO-8601 with the Moscow offset `+03:00` (MSK, no
   ...
   - «завтра в 15:00» → `2026-06-09T15:00:00+03:00`
   - «через час» → now + 1 hour, in `…+03:00`
